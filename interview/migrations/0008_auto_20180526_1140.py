...
def migrate_state(apps, schema_editor):
    ...
    for i in Interview.objects.all():
        ...
        if is_new or (
            Interview.objects.filter(process=i.process).last() == i and i.process.state not in P2.CLOSED_STATE_VALUES
        ):
            if i.state == "NP":
                i.process.state = "WP"
...
class Migration(migrations.Migration):
    ...
    dependencies = [("interview", "0007_auto_20180526_0944")]

    operations = [migrations.RunPython(migrate_state)]
