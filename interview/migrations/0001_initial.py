    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "document_type",
                    models.CharField(choices=[("CV", "CV"), ("CL", "Cover Letter"), ("OT", "Others")], max_length=2),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "next_state",
                    models.CharField(
                        choices=[("NP", "NEED PLANIFICATION"), ("PL", "PLANNED"), ("GO", "GO"), ("NO", "NO")],
                        max_length=3,
                ...
                (
                    "minute_format",
                    models.CharField(
                        choices=[("md", "Markdown"), ("rst", "ReStructured Text")], default="md", max_length=3
                    ),
                ),
                ("next_interview_goal", models.TextField(blank=True, verbose_name="Next interview goal")),
            ],
            options={"ordering": ["process", "rank"]},
        ),
        migrations.CreateModel(
            name="Process",
            fields=[
                ...
                (
                    "salary_expectation",
                    models.IntegerField(blank=True, null=True, verbose_name="Salary expectation (k€)"),
                ),
                (
                    "contract_duration",
                    models.PositiveIntegerField(blank=True, null=True, verbose_name="Contract duration in month"),
                ),
